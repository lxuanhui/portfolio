...
const Experience = () => (
    <div id='experience' className="bg-white px-2 sm:px-4 py-6 sm:py-8 dark:bg-slate-900">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 px-1 sm:px-2">
          {/* Card 1 - Disney */}
          <div className="w-full">
            <div className="bg-white hover:bg-gray-100 p-3 sm:p-4 rounded-lg shadow-lg transition duration-300 ease-in-out dark:bg-slate-800 dark:hover:bg-slate-600 h-full flex flex-col">
              ...
              <div className="text-gray-600 text-xs sm:text-sm dark:text-slate-300 text-left space-y-2 flex-grow">
              ...
              <div className="flex flex-wrap justify-center pt-3 sm:pt-4 mt-auto">
                <Badge>Web Dev</Badge>
                <Badge>AWS</Badge>
